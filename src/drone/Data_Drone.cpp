...
/*******************initialize interval of the message with this id***********************/
int Drone::init_msg_rate(int msg_id, int interval_us)
{	
    //Message buffer
	mavlink_message_t message;
    mavlink_command_long_t command;
    ...
    command.target_component = 1;
    command.command = MAV_CMD_SET_MESSAGE_INTERVAL;
    command.param1  = msg_id; //rate
	command.param2  = interval_us; //intervall en us
    command.param3  = 0;//default Response Target
